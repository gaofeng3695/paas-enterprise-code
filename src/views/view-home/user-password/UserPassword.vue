<template>
  <div class="view-userPassword">
    <div style="width:360px; margin:130px auto 10px auto">
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px">
        ...
        <div>
          <el-button type="primary" @click="cancel" style="width:120px; marginLeft:100px">保存</el-button>
          <el-button type="primary" @click="confirm" style="width:120px">取消</el-button>
        </div>
      </el-form>
    </div>
  </div>
